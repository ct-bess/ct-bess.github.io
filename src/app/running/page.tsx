  ...
  return(
    <main>
      <div className="running-profile-container float-item">
        ...
        <h2 className="center"><span>The &quot;Why&quot;</span></h2>
        <div className="light-black-background">
          <p className="blurb">
            It&apos;s the question that plagues all of us. When running or not running, it has a way of creeping into our minds at the worst possible times when we&apos;re most vulnerable.
          ...
          <p className="blurb">
            My why is simple, it&apos;s basic self mastery, discovery, and actualization. Why do I continue to run these races or push myself to do better in general?
            ...
            That&apos;s not my only reason of course, just my main reason. I also run and workout to stay fit, I run for the joy of it, and I run for community.
      ...
      <h2 className="center"><span>Marathon History</span></h2>

      <div className="race-container marathon-container">
        <p className="blurb light-black-background">
      ...
      <h2 className="center"><span>Half Marathon History</span></h2>

      <div className="race-container half-marathon-container">
        <p className="blurb light-black-background">
      ...
      <h2 className="center"><span>5K History</span></h2>

      <div className="race-container five-k-container">
        <div className="light-black-background">
          <p className="blurb">
      ...
      <h2 className="center"><span>Other Distances</span></h2>

      <div className="race-container other-container">
        <p className="blurb light-black-background">
